...
If the question does not seem related to any table, just return "I don't \
know" as the answer.
You may actively speculate on reasons describing categories differences or \
similarities, or their defining feature values.
Trip is travel or flight, Company is airlines.

Here are some other examples of user inputs and their corresponding SQL \
queries:"""

# TABLE_DESCRIPTIONS contain description for all tables in DB
TABLE_DESCRIPTIONS = {
    "company": "Use 'company' table, if you are asked to provide "    +
        "information about airlines or if you are asked to provide "  +
        "information related to any airline.",
    "passenger": "Use 'passenger' table if you are asked to provide " +
        "data about passengers or people.",
    "pass_in_trip": "Use 'pass_in_trip' table if you are asked to "   +
        "provide information about the passenger's place on the "     +
        "plane. Also use this table to link the 'passenger' and "     +
        "'trip' tables to each other.",
    "trip": "Use 'trip' table if you are asked to provide trip "      +
        "information. If you are asked to provide information about " +
        "the departure time or else information about a particular "  +
        "passenger, then contact the 'passenger' table using 'pass_in_trip'"
}

SUFFIX = """You are working on the problem of INFORMING PASSENGERS, you \
should provide the required information unchanged. 
...
4. If information is requested for a specific period, then include \
information only from that period.
